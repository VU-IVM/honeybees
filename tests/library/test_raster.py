# -*- coding: utf-8 -*-
from honeybees.library.raster import pixel_to_coord, pixels_to_coords, reproject_pixel, coord_to_pixel, coords_to_pixels
import numpy as np

def test_reproject_pixel():
    from_gt = (73.517314369, 0.00026949458512559436, 0.0, 18.438819522, 0.0, -0.0002694945854623959)                                 
    to_gt = (73.1666666666954, 0.008333333333339965, 0.0, 19.500000000006278, 0.0, -0.008333333333339965)
...
def test_pixel_to_coord():
    gt = (73.517314369, 0.00026949458512559436, 0.0, 18.438819522, 0.0, -0.0002694945854623959)  
    lon, lat = pixel_to_coord(10, 56, gt)
    assert lon == 73.517314369 + 10 * 0.00026949458512559436 and lat == 18.438819522 + 56 * -0.0002694945854623959
...
def test_coord_to_pixel():
    gt = (73.517314369, 0.00026949458512559436, 0.0, 18.438819522, 0.0, -0.0002694945854623959)  
    px, py = coord_to_pixel((73.517314369 + 10 * 0.00026949458512559436, 18.438819522 + 56 * -0.0002694945854623959), gt)
    assert px == 10 and py == 56
    px, py = coord_to_pixel((73.517314369 + 10 * 0.00026949458512559436 - 0.000001, 18.438819522 + 56 * -0.0002694945854623959 + 0.000001), gt)
